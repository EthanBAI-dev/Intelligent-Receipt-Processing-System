...
train_dataset = RotatedReceiptDataset(root_dir='./data/train/images', transform=data_transforms['train'])
test_dataset = RotatedReceiptDataset(root_dir='./data/test/images', transform=data_transforms['val'])
